...
const PROCESS_STEPS = [
  {
    ...
    description: "Choose a time that works for you using our calendar. Booking is free — no payment required to reserve your spot.",
  },
  {
    step: "02",
    title: "We prepare",
...
const FAQ = [
  ...
  {
    q: "How does the $299 work?",
    a: "Booking is free — you pay nothing to schedule. The $299 covers the strategy call and your custom AI automation plan, invoiced after the call. If we don't deliver a useful plan, we'll work with you to make it right.",
  },
  {
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-gray-10 rounded-2xl p-8 border border-gray-20">
            <div className="mb-6">
              ...
              <div className="text-sm text-gray-50 mt-1">45-Minute Strategy Call + AI Automation Plan — free to book</div>
            </div>
  ...
  return (
    <section className="py-20 px-6 bg-gray-90 text-white">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-xs text-gray-50 mt-4">Free to book — no payment required. Limited spots available — we work with a small number of clients at a time.</p>
      </div>
    </section>
  );
}
